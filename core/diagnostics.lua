...
-- current progress: 249/249 : stable ( 1.6.2026 )
...
add_test('transpiler_68', function()
    ...
    local ast = core.PARS(tokens)
    local code = core.TPIL(ast)
    return strfind(code, 'print(arg)', 1, true)
end)
...
add_test('transpiler_108', function()
    ...
    local ast = core.PARS(tokens)
    local code = core.TPIL(ast)
    return strfind(code, "print(a .. b)", 1, true)
end)
...
add_test('transpiler_112', function()
    ...
    local ast = core.PARS(tokens)
    local code = core.TPIL(ast)
    return strfind(code, 'print(table.getn(arg))', 1, true)
end)
